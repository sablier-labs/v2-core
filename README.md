...
- Several files in `src/abstracts/`, `src/libraries/`, and `script` may also be licensed under `GPL-3.0-or-later` (as
  indicated in their SPDX headers), see [`LICENSE-GPL.md`](./GPL-LICENSE.md).
