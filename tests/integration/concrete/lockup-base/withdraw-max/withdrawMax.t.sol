...
contract WithdrawMax_Integration_Concrete_Test is Integration_Test {
    function test_GivenEndTimeNotInFuture() external {
        ...
        uint128 actualReturnedValue = lockup.withdrawMax({ streamId: streamIds.defaultStream, to: users.recipient });
    ...
    function test_GivenEndTimeInFuture() external {
        ...
        // Make the max withdrawal.
        uint128 actualWithdrawnAmount = lockup.withdrawMax({ streamId: streamIds.defaultStream, to: users.recipient });
