...
abstract contract StreamedAmountOf_Integration_Concrete_Test is Integration_Test {
    function test_RevertGiven_Null() external {
        expectRevert_Null({ callData: abi.encodeCall(lockup.streamedAmountOf, streamIds.nullStream) });
    }
    ...
    function test_GivenCanceledStreamAndCANCELEDStatus() external givenNotNull {
        ...
        uint128 actualStreamedAmount = lockup.streamedAmountOf(streamIds.defaultStream);
