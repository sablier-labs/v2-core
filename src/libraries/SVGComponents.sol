...
library SVGComponents {
    ...
    string internal constant LIGHT = '<g id="light"><circle r="500" fill="url(#fillLight)"/></g>';
        ...
        returns (string memory, uint256)
    {
        ...
        vars.element = string.concat(
            ...
            vars.label,
            "</text>",
            '<text x="20" y="72" font-size="26px" font-family="\'Courier New\', \'Arial\', \'monospace\'">',
            text,
            "</text></g>"
        );
    ...
    function styles(string memory colorAccent) internal pure returns (string memory) {
        return string.concat(
            ...
            '"/>',
            "</linearGradient>",
            '<linearGradient id="fillRight" x1="100%" y1="100%">',
            ...
            "</linearGradient>",
            '<linearGradient id="fillLeft" x1="0%" y1="0%">',
    ...
    function words(string memory offset, string memory text) internal pure returns (string memory) {
        return string.concat(
            ...
            offset,
            '" href="#boxOutline" fill="white" fill-opacity="0.8" font-size="26px" font-family="\'Courier New\', \'Arial\', \'monospace\'">',
