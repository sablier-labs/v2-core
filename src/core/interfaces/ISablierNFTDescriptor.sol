...
interface ISablierNFTDescriptor {
    ...
    /// @param lockup The address of the Lockup contract the stream was created in.
    ...
    function tokenURI(IERC721Metadata lockup, uint256 streamId) external view returns (string memory uri);
}
