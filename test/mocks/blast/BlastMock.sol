...
contract BlastMock {
    ...
    mapping(address account => address governor) public governorMap;
...
contract GasMock {
    ...
    mapping(address account => GasMode mode) internal _gasMode;

    modifier onlyBlastMock() {
        require(msg.sender == BLAST_MOCK, "Caller must be blast contract");
        _;
    }
...
contract YieldMock {
    ...
    mapping(address account => YieldMode mode) internal _yieldMode;
