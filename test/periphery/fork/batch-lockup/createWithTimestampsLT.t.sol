...
import { BatchLockup, Lockup, LockupTranched } from "src/core/types/DataTypes.sol";
...
abstract contract CreateWithTimestampsLT_BatchLockup_Fork_Test is Fork_Test {
    ...
    function testForkFuzz_CreateWithTimestampsLT(CreateWithTimestampsParams memory params) external {
        ...
        BatchLockup.CreateWithTimestampsLT[] memory batchParams =
            BatchLockupBuilder.fillBatch(createWithTimestamps, params.tranches, params.batchSize);
        ...
        uint256[] memory actualStreamIds = batchLockup.createWithTimestampsLT(lockup, FORK_ASSET, batchParams);
