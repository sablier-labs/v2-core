...
abstract contract MerkleLT_Integration_Shared_Test is MerkleCampaign_Integration_Test {
...
contract Clawback_MerkleLT_Integration_Test is MerkleLT_Integration_Shared_Test, Clawback_Integration_Test {
    function setUp() public override(MerkleLT_Integration_Shared_Test, MerkleCampaign_Integration_Test) {
...
contract WithdrawFees_MerkleLT_Integration_Test is MerkleLT_Integration_Shared_Test, WithdrawFees_Integration_Test {
    function setUp() public override(MerkleLT_Integration_Shared_Test, MerkleCampaign_Integration_Test) {
        MerkleLT_Integration_Shared_Test.setUp();
    }
}
