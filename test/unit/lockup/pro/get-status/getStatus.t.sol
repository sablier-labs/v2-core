...
import { GetStatus_Unit_Test } from "test/unit/lockup/shared/get-status/getStatus.t.sol";
import { Unit_Test } from "test/unit/Unit.t.sol";

contract IsEntity_Pro_Unit_Test is Pro_Unit_Test, GetStatus_Unit_Test {
