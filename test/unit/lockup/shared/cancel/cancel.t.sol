...
abstract contract Cancel_Test is Shared_Test {
        ...
        noRecipientReentrancy
    {
        ...
        // Expect the assets to be withdrawn to the recipient, if not zero.
        ...
        // Expect the assets to be returned to the sender, if not zero.
