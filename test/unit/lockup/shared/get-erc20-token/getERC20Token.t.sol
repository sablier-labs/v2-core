...
abstract contract GetERC20Token_Test is Shared_Test {
    /// @dev it should return the zero address.
    function test_GetERC20Token_StreamNull() external {
        uint256 nullStreamId = 1729;
        IERC20 actualToken = lockup.getERC20Token(nullStreamId);
    ...
    function test_GetERC20Token() external streamNonNull {
        ...
        IERC20 actualToken = lockup.getERC20Token(streamId);
