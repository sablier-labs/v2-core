...
contract SablierV2Pro__WithdrawAllTo is SablierV2ProUnitTest {
    ...
    function setUp() public override {
        ...
        defaultAmounts.push(SEGMENT_AMOUNTS_DAI[0]);
        defaultAmounts.push(SEGMENT_AMOUNTS_DAI[0]);
    ...
    function testCannotWithdrawAllTo__ToZeroAddress() external {
        ...
        sablierV2Pro.withdrawAllTo(defaultStreamIds, toZero, defaultAmounts);
    }
    ...
    function testCannotWithdrawAllTo__ArraysNotEqual() external ToNonZeroAddress {
        ...
        sablierV2Pro.withdrawAllTo(streamIds, toAlice, amounts);
    }
    ...
    function testCannotWithdrawAllTo__OnlyNonExistentStreams() external ToNonZeroAddress ArraysEqual {
        ...
        uint256[] memory amounts = createDynamicArray(SEGMENT_AMOUNTS_DAI[0]);
        sablierV2Pro.withdrawAllTo(nonStreamIds, toAlice, amounts);
    }
    ...
    function testCannotWithdrawAllTo__SomeNonExistentStreams() external ToNonZeroAddress ArraysEqual {
        ...
        // Run the test.
        sablierV2Pro.withdrawAllTo(streamIds, toAlice, defaultAmounts);
        ISablierV2Pro.Stream memory queriedStream = sablierV2Pro.getStream(defaultStreamIds[0]);
        ...
        OnlyExistentStreams
    {
        ...
        sablierV2Pro.withdrawAllTo(defaultStreamIds, toAlice, defaultAmounts);
    }
        ...
        OnlyExistentStreams
    {
        ...
        changePrank(users.recipient);
        uint256 reversedStreamId = sablierV2Pro.create(
            users.recipient,
            daiStream.sender,
        ...
        CallerRecipient
    {
        ...
        // Run the test.
        uint256[] memory amounts = createDynamicArray(SEGMENT_AMOUNTS_DAI[0], 0);
        vm.expectRevert(abi.encodeWithSelector(ISablierV2.SablierV2__WithdrawAmountZero.selector, defaultStreamIds[1]));
        sablierV2Pro.withdrawAllTo(defaultStreamIds, toAlice, amounts);
    }
        ...
        CallerRecipient
    {
        ...
        // Run the test.
        uint256 withdrawableAmount = SEGMENT_AMOUNTS_DAI[0];
        ...
        AllAmountsLessThanOrEqualToWithdrawableAmounts
    {
        ...
        sablierV2Pro.withdrawAllTo(defaultStreamIds, toRecipient, defaultAmounts);
        ISablierV2Pro.Stream memory queriedStream0 = sablierV2Pro.getStream(defaultStreamIds[0]);
        ISablierV2Pro.Stream memory queriedStream1 = sablierV2Pro.getStream(defaultStreamIds[1]);
        ...
        uint256 expectedWithdrawnAmount0 = SEGMENT_AMOUNTS_DAI[0];
        uint256 expectedWithdrawnAmount1 = SEGMENT_AMOUNTS_DAI[0];
        ...
        ToThirdParty
    {
        ...
        ISablierV2Pro.Stream memory actualStream0 = sablierV2Pro.getStream(endedDaiStreamId);
        ISablierV2Pro.Stream memory expectedStream0;
        assertEq(actualStream0, expectedStream0);

        ISablierV2Pro.Stream memory queriedStream1 = sablierV2Pro.getStream(ongoingStreamId);
        uint256 actualWithdrawnAmount1 = queriedStream1.withdrawnAmount;
        uint256 expectedWithdrawnAmount1 = SEGMENT_AMOUNTS_DAI[0];
        assertEq(actualWithdrawnAmount1, expectedWithdrawnAmount1);
    }
