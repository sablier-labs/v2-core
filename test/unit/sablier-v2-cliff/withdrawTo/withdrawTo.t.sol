...
contract SablierV2Cliff__Withdraw__UnitTest is SablierV2CliffUnitTest {
    ...
    function testCannotWithdrawTo__WithdrawToZeroAddress() external {
        ...
        sablierV2Cliff.withdrawTo(streamId, withdrawAmount, to);
    }
    ...
    function testCannotWithdraw__StreamNonExistent() external {
        ...
        sablierV2Cliff.withdrawTo(nonStreamId, withdrawAmount, to);
    }
    ...
    function testCannotWithdraw__WithdrawAmountGreaterThanWithdrawableAmount() public {
        ...
        sablierV2Cliff.withdrawTo(streamId, withdrawAmountMaxUint256, to);
    }
    ...
    function testWithdraw__StreamOngoing() public {
        ...
        // Run the test.
        address to = stream.recipient;
        sablierV2Cliff.withdrawTo(streamId, DEFAULT_WITHDRAW_AMOUNT, to);
    }
    ...
    function testWithdraw__StreamOngoing__UpdateWithdrawnAmount() public {
        ...
        sablierV2Cliff.withdrawTo(streamId, withdrawnAmount, to);
