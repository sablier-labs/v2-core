...
abstract contract Fork_Test is Base_Test {
    ...
    constructor() {
        ...
        // TODO: add all other chains addresses
    }
    ...
    modifier runForkTest() {
        if (!isForkMultichainProfile()) {
            ...
            // Run the test for all assets.
            for (uint256 i = 0; i < forkChains.arbitrum.assets.length; ++i) {
    ...
    function setUp() public virtual override {
        ...
        forkChains.mainnet.id = vm.createFork({ urlOrAlias: "mainnet" });
        forkChains.arbitrum.id = vm.createFork({ urlOrAlias: "arbitrum" });
