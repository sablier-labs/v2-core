...
abstract contract LockupDynamic_Fork_Test is Fork_Test {
    ...
    function setUp() public virtual override {
        ...
        (bool success,) = address(FORK_ASSET).call(abi.encodeCall(IERC20.approve, (address(lockupDynamic), MAX_UINT256)));
        success;
    }
    ...
    function testForkFuzz_LockupDynamic_CreateWithdrawCancel(Params memory params) external {
        ...
        vars.balances =
            getTokenBalances(address(FORK_ASSET), Solarray.addresses(address(lockupDynamic), FORK_ASSET_HOLDER, params.broker.account));
