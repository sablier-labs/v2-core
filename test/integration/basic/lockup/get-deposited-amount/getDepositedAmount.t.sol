...
abstract contract GetDepositedAmount_Integration_Basic_Test is Integration_Test, Lockup_Integration_Shared_Test {
    ...
    function test_GetDepositedAmount() external whenNotNull {
