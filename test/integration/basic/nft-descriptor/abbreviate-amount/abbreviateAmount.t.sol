...
contract AbbreviateAmount_Integration_Test is NFTDescriptor_Integration_Basic_Test {
    ...
    function test_AbbreviateAmount_Tiny() external {
        ...
        assertEq(abbreviateAmount({ amount: 0, decimals: 0 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 5, decimals: 1 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 9, decimals: 1 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 42, decimals: 2 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 99, decimals: 2 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e18 - 1, decimals: 18 }), expectedAbbreviation, "abbreviation");
    }
    ...
    function test_AbbreviateAmount_Zillions() external {
        ...
        assertEq(abbreviateAmount({ amount: 1e15, decimals: 0 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e16, decimals: 1 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e16 + 1, decimals: 1 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e17, decimals: 2 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e17 + 1, decimals: 2 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e33, decimals: 18 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: 1e33 + 1, decimals: 18 }), expectedAbbreviation, "abbreviation");
        assertEq(abbreviateAmount({ amount: MAX_UINT128, decimals: 18 }), expectedAbbreviation, "abbreviation");
    }

    function test_AbbreviateAmount_NoSuffix() external {
        assertEq(abbreviateAmount({ amount: 1, decimals: 0 }), ge("1"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 5, decimals: 0 }), ge("5"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 121, decimals: 1 }), ge("12"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 1337, decimals: 2 }), ge("13"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 78_921, decimals: 2 }), ge("789"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 988e18, decimals: 18 }), ge("988"), "abbreviation");
    }
    ...
    function test_AbbreviateAmount_Trillions() external {
        assertEq(abbreviateAmount({ amount: 2_578_924_152_034, decimals: 0 }), ge("2.57T"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 3_931_548_209_201, decimals: 0 }), ge("3.93T"), "abbreviation");
        assertEq(abbreviateAmount({ amount: 60_008_233_054_613, decimals: 1 }), ge("6T"), "abbreviation");
