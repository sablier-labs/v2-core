...
abstract contract LockupLinear_Integration_Basic_Test is Integration_Test, LockupLinear_Integration_Shared_Test {
...
contract Burn_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    Burn_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, Burn_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        Burn_Integration_Basic_Test.setUp();
    }
}

contract Cancel_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    Cancel_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, Cancel_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        Cancel_Integration_Basic_Test.setUp();
    }
}

contract CancelMultiple_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    CancelMultiple_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, CancelMultiple_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract ClaimProtocolRevenues_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    ClaimProtocolRevenues_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, ClaimProtocolRevenues_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract GetAsset_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetAsset_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, GetAsset_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        GetAsset_Integration_Basic_Test.setUp();
    }
}

contract GetDepositedAmount_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetDepositedAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, GetDepositedAmount_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract GetEndTime_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetEndTime_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, GetEndTime_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        GetEndTime_Integration_Basic_Test.setUp();
    }
}

contract GetRecipient_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetRecipient_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, GetRecipient_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract GetRefundedAmount_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetRefundedAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, GetRefundedAmount_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract GetSender_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetSender_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, GetSender_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        GetSender_Integration_Basic_Test.setUp();
    }
}

contract GetStartTime_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetStartTime_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, GetStartTime_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract GetWithdrawnAmount_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    GetWithdrawnAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, GetWithdrawnAmount_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract IsCancelable_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    IsCancelable_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, IsCancelable_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract IsCold_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    IsCold_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, IsCold_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        IsCold_Integration_Basic_Test.setUp();
    }
}

contract IsDepleted_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    IsDepleted_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, IsDepleted_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        IsDepleted_Integration_Basic_Test.setUp();
    }
}

contract IsStream_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    IsStream_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, IsStream_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        IsStream_Integration_Basic_Test.setUp();
    }
}

contract IsWarm_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    IsWarm_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, IsWarm_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        IsWarm_Integration_Basic_Test.setUp();
    }
}

contract ProtocolRevenues_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    ProtocolRevenues_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, ProtocolRevenues_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract Renounce_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    Renounce_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, Renounce_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        Renounce_Integration_Basic_Test.setUp();
    }
}

contract RefundableAmountOf_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    RefundableAmountOf_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, RefundableAmountOf_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract SetComptroller_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    SetComptroller_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, SetComptroller_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract SetNFTDescriptor_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    SetNFTDescriptor_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, SetNFTDescriptor_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
...
contract StatusOf_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    StatusOf_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, StatusOf_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        StatusOf_Integration_Basic_Test.setUp();
    }
}

contract WasCanceled_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    WasCanceled_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, WasCanceled_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        WasCanceled_Integration_Basic_Test.setUp();
    }
}

contract Withdraw_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    Withdraw_Integration_Basic_Test
{
    function setUp() public virtual override(LockupLinear_Integration_Basic_Test, Withdraw_Integration_Basic_Test) {
        LockupLinear_Integration_Basic_Test.setUp();
        Withdraw_Integration_Basic_Test.setUp();
    }
}

contract WithdrawMax_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
...
contract WithdrawMultiple_LockupLinear_Integration_Basic_Test is
    LockupLinear_Integration_Basic_Test,
    WithdrawMultiple_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, WithdrawMultiple_Integration_Basic_Test)
    {
        LockupLinear_Integration_Basic_Test.setUp();
