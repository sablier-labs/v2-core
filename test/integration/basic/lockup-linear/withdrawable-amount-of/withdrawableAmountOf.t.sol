...
contract WithdrawableAmountOf_LockupLinear_Integration_Basic_Test is
    ...
    WithdrawableAmountOf_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupLinear_Integration_Basic_Test, WithdrawableAmountOf_Integration_Basic_Test)
    {
