...
contract StreamedAmountOf_LockupDynamic_Integration_Basic_Test is
    ...
    StreamedAmountOf_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, StreamedAmountOf_Integration_Basic_Test)
    {
