...
abstract contract LockupDynamic_Integration_Basic_Test is Integration_Test, LockupDynamic_Integration_Shared_Test {
    function setUp() public virtual override(Integration_Test, LockupDynamic_Integration_Shared_Test) {
        ...
        base = ISablierV2Lockup(lockupDynamic);
...
contract Burn_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    Burn_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, Burn_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        Burn_Integration_Basic_Test.setUp();
    }
}

contract Cancel_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    Cancel_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, Cancel_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        Cancel_Integration_Basic_Test.setUp();
    }
}

contract CancelMultiple_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    CancelMultiple_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, CancelMultiple_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract ClaimProtocolRevenues_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    ClaimProtocolRevenues_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, ClaimProtocolRevenues_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract GetAsset_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetAsset_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, GetAsset_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        GetAsset_Integration_Basic_Test.setUp();
    }
}

contract GetDepositedAmount_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetDepositedAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, GetDepositedAmount_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract GetEndTime_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetEndTime_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, GetEndTime_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        GetEndTime_Integration_Basic_Test.setUp();
    }
}

contract GetRecipient_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetRecipient_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, GetRecipient_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract GetRefundedAmount_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetRefundedAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, GetRefundedAmount_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract ProtocolRevenues_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    ProtocolRevenues_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, ProtocolRevenues_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract RefundableAmountOf_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    RefundableAmountOf_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, RefundableAmountOf_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract GetSender_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetSender_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, GetSender_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        GetSender_Integration_Basic_Test.setUp();
    }
}

contract GetStartTime_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetStartTime_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, GetStartTime_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract GetWithdrawnAmount_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    GetWithdrawnAmount_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, GetWithdrawnAmount_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract IsCancelable_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    IsCancelable_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, IsCancelable_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract IsCold_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    IsCold_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, IsCold_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        IsCold_Integration_Basic_Test.setUp();
    }
}

contract IsDepleted_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    IsDepleted_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, IsDepleted_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        IsDepleted_Integration_Basic_Test.setUp();
    }
}

contract IsStream_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    IsStream_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, IsStream_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        IsStream_Integration_Basic_Test.setUp();
    }
}

contract IsWarm_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    IsWarm_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, IsWarm_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        IsWarm_Integration_Basic_Test.setUp();
    }
}

contract Renounce_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    Renounce_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, Renounce_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        Renounce_Integration_Basic_Test.setUp();
    }
}

contract SetComptroller_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    SetComptroller_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, SetComptroller_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract SetNFTDescriptor_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    SetNFTDescriptor_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, SetNFTDescriptor_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract StatusOf_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    StatusOf_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, StatusOf_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        StatusOf_Integration_Basic_Test.setUp();
    }
}

contract WasCanceled_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    WasCanceled_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, WasCanceled_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract Withdraw_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    Withdraw_Integration_Basic_Test
{
    function setUp() public virtual override(LockupDynamic_Integration_Basic_Test, Withdraw_Integration_Basic_Test) {
        LockupDynamic_Integration_Basic_Test.setUp();
        Withdraw_Integration_Basic_Test.setUp();
    }
}

contract WithdrawMax_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    WithdrawMax_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, WithdrawMax_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract WithdrawMaxAndTransfer_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    WithdrawMaxAndTransfer_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, WithdrawMaxAndTransfer_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
...
contract WithdrawMultiple_LockupDynamic_Integration_Basic_Test is
    LockupDynamic_Integration_Basic_Test,
    WithdrawMultiple_Integration_Basic_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Basic_Test, WithdrawMultiple_Integration_Basic_Test)
    {
        LockupDynamic_Integration_Basic_Test.setUp();
