    ...
    Lockup_Integration_Shared_Test
{
    function setUp() public virtual override(Integration_Test, Lockup_Integration_Shared_Test) {
        ...
        ERC20RebasingMock(address(erc20RebasingMock)).setClaimableAmount(address(lockup), 100);
    }

    function test_RevertGiven_NotClaimableYield() external {
        // Run the test.
        vm.expectRevert();
        lockup.getClaimableRebasingAssetYield(erc20RebasingMock);
    }
    ...
    function test_GetClaimableRebasingAssetYield() external givenClaimableYield {
        // Run the test.
        uint256 actualClaimableAmount = lockup.getClaimableRebasingAssetYield(erc20RebasingMock);
