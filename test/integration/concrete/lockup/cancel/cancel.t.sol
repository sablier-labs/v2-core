...
abstract contract Cancel_Integration_Concrete_Test is Integration_Test, Cancel_Integration_Shared_Test {
    ...
    function test_RevertWhen_StatusDepleted() external whenNotDelegateCalled whenNotNull givenStreamCold {
    ...
    function test_RevertWhen_StatusCanceled() external whenNotDelegateCalled whenNotNull givenStreamCold {
    ...
    function test_RevertWhen_StatusSettled() external whenNotDelegateCalled whenNotNull givenStreamCold {
        vm.warp({ timestamp: defaults.END_TIME() });
