...
import { GetAssetConfiguration_Integration_Concrete_Test } from
    "../lockup/get-asset-configuration/getAssetConfiguration.t.sol";
import { GetClaimableAssetYield_Integration_Concrete_Test } from
    "../lockup/get-claimable-asset-yield/getClaimableAssetYield.t.sol";
...
contract ClaimProtocolRevenues_LockupDynamic_Integration_Concrete_Test is
    LockupDynamic_Integration_Concrete_Test,
    ClaimProtocolRevenues_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Concrete_Test, ClaimProtocolRevenues_Integration_Concrete_Test)
    {
        LockupDynamic_Integration_Concrete_Test.setUp();
...
contract ClaimRebasingAssetYield_LockupDynamic_Integration_Concrete_Test is
    LockupDynamic_Integration_Concrete_Test,
    ClaimRebasingAssetYield_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Concrete_Test, ClaimRebasingAssetYield_Integration_Concrete_Test)
    {
        LockupDynamic_Integration_Concrete_Test.setUp();
...
contract GetAssetConfiguration_LockupDynamic_Integration_Concrete_Test is
    LockupDynamic_Integration_Concrete_Test,
    GetAssetConfiguration_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Concrete_Test, GetAssetConfiguration_Integration_Concrete_Test)
    {
        LockupDynamic_Integration_Concrete_Test.setUp();
        GetAssetConfiguration_Integration_Concrete_Test.setUp();
    }
}
...
contract ProtocolRevenues_LockupDynamic_Integration_Concrete_Test is
    LockupDynamic_Integration_Concrete_Test,
    ProtocolRevenues_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Concrete_Test, ProtocolRevenues_Integration_Concrete_Test)
    {
        LockupDynamic_Integration_Concrete_Test.setUp();
...
contract SetComptroller_LockupDynamic_Integration_Concrete_Test is
    LockupDynamic_Integration_Concrete_Test,
    SetComptroller_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(LockupDynamic_Integration_Concrete_Test, SetComptroller_Integration_Concrete_Test)
    {
        LockupDynamic_Integration_Concrete_Test.setUp();
