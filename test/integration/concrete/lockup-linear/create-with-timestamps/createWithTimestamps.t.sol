    ...
    CreateWithTimestamps_Integration_Shared_Test
{
        ...
        whenDepositAmountNotZero
    {
        ...
        createDefaultStreamWithTimestamps(LockupLinear.Timestamp({ start: 0, cliff: cliffTime, end: endTime }));
    }
        ...
        whenCliffTimeZero
    {
        ...
        createDefaultStreamWithTimestamps(LockupLinear.Timestamp({ start: startTime, cliff: 0, end: endTime }));
    }
        ...
        whenCliffTimeZero
    {
        createDefaultStreamWithTimestamps(
            LockupLinear.Timestamp({ start: defaults.START_TIME(), cliff: 0, end: defaults.END_TIME() })
        );
