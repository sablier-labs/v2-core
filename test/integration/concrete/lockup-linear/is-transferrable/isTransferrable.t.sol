...
contract IsTransferrable_LockupLinear_Integration_Concrete_Test is LockupLinear_Integration_Concrete_Test {
    ...
    function test_RevertGiven_Null() external {
        ...
        lockupLinear.isTransferrable(nullStreamId);
    }
    ...
    function test_RevertGiven_StreamTransferNotEnabled() external givenNotNull {
        ...
        bool isTransferrable = lockupLinear.isTransferrable(noTransferStreamId);
    ...
    function test_IsTransferrable_Stream() external givenNotNull givenStreamTransferEnabled {
        bool isTransferrable = lockupLinear.isTransferrable(defaultStreamId);
