...
contract USDC_CreateWithMilestones_Test is CreateWithMilestones_Test(token, holder) {}

contract USDC_CreateWithRange_Test is CreateWithRange_Test(token, holder) {}
