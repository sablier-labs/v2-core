...
contract USDT_CreateWithMilestones_Test is CreateWithMilestones_Test(token, holder) {}

contract USDT_CreateWithRange_Test is CreateWithRange_Test(token, holder) {}
