...
contract AllowToHook_Lockup_Tranched_Integration_Concrete_Test is
...
contract Batch_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract Burn_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract CancelMultiple_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
    CancelMultiple_Integration_Concrete_Test
{
    ...
    function setUp()
        public
        virtual
        override(Lockup_Tranched_Integration_Shared_Test, CancelMultiple_Integration_Concrete_Test)
    {
        Lockup_Tranched_Integration_Shared_Test.setUp();
...
contract GetAsset_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetDepositedAmount_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetEndTime_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetRecipient_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetRefundedAmount_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetSender_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetStartTime_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract GetWithdrawnAmount_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsAllowedToHook_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsCancelable_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsCold_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsDepleted_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsStream_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsTransferable_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract IsWarm_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract SetNFTDescriptor_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract StatusOf_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract TransferFrom_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract WasCanceled_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract WithdrawHooks_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
    WithdrawHooks_Integration_Concrete_Test
{
    function setUp()
        public
        virtual
        override(Lockup_Tranched_Integration_Shared_Test, WithdrawHooks_Integration_Concrete_Test)
    {
        Lockup_Tranched_Integration_Shared_Test.setUp();
...
contract WithdrawMax_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract WithdrawMaxAndTransfer_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
...
contract WithdrawMultiple_Lockup_Tranched_Integration_Concrete_Test is
    Lockup_Tranched_Integration_Shared_Test,
    WithdrawMultiple_Integration_Concrete_Test
{
    ...
    function setUp()
        public
        virtual
        override(Lockup_Tranched_Integration_Shared_Test, WithdrawMultiple_Integration_Concrete_Test)
    {
        Lockup_Tranched_Integration_Shared_Test.setUp();
