    ...
    WithdrawMultiple_Integration_Shared_Test
{
        ...
        givenNoNull
    {
        ...
        lockup.withdrawMax({ streamId: testStreamIds[0], to: users.recipient1 });
        ...
        whenNoAmountOverdraws
    {
        ...
        expectCallToTransfer({ to: users.recipient1, value: testAmounts[0] });
        expectCallToTransfer({ to: users.recipient1, value: testAmounts[1] });
        expectCallToTransfer({ to: users.recipient1, value: testAmounts[2] });
        ...
        assertEq(lockup.getRecipient(testStreamIds[0]), users.recipient1, "NFT owner0");
        assertEq(lockup.getRecipient(testStreamIds[1]), users.recipient1, "NFT owner1");
        assertEq(lockup.getRecipient(testStreamIds[2]), users.recipient1, "NFT owner2");
    }
}
